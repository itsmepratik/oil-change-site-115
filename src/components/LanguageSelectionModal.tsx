...
const LanguageSelectionModal = ({ onLanguageSelected }: LanguageSelectionModalProps) => {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-md p-6 rounded-xl border border-white/10 bg-background shadow-lg animate-in fade-in-0 zoom-in-95 duration-300">
